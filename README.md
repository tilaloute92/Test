...
- **Équipe** : fiches membres (rôle, compétences, volume horaire), gestion des absences/indisponibilités (congés, formation, télétravail, astreinte) qui viennent réduire la capacité disponible.

Les données sont stockées dans le navigateur (`localStorage`) ; aucun backend n'est requis pour ce prototype.
