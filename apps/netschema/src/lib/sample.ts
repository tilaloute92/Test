...
export function sampleDiagram(): Diagram {
  return {
    ...
    links: [
      ...
      link('core1', 'distA', 'fiber', { speed: '10 Gb/s', mode: 'trunk', vlans: '20,40,50', lag: 'Po10', mtu: 9000, stp: 'root' }),
      link('core2', 'distA', 'fiber', { redundant: true, mode: 'trunk', vlans: '20,40,50', stp: 'blocking' }),
      link('core1', 'distB', 'fiber', { redundant: true, mode: 'trunk', vlans: '30', stp: 'blocking' }),
      link('core2', 'distB', 'fiber', { speed: '10 Gb/s', mode: 'trunk', vlans: '30', lag: 'Po11', mtu: 9000, stp: 'root' }),

      link('distA', 'accA', 'ethernet', { speed: '1 Gb/s', mode: 'trunk', vlans: '20,50', nativeVlan: '1' }),
      link('distA', 'wifiA', 'ethernet', { label: 'PoE+', mode: 'trunk', vlans: '40', nativeVlan: '1' }),
      link('distB', 'accB', 'ethernet', { speed: '1 Gb/s', mode: 'trunk', vlans: '30', nativeVlan: '1' }),
